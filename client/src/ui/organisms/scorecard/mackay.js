      ...
      <div>
            ...
            <Row alignItems="center" justifyContent="center">
              <Column sm={12} md={10}>
                <Accordion atomic={true}>
                  <AccordionItem title="Workplace Relations">
                    <Content1 />
                  </AccordionItem>

                  <AccordionItem title="Energy">
                    <Content2 />
                  </AccordionItem>

                  <AccordionItem title="Vocational Education">
                    <Content3 />
                  </AccordionItem>
                </Accordion>
              </Column>
        ...
        <Section backgroundColor={this.props.backgroundColor} space={2}>
          <Container>
            <Row alignItems="center" justifyContent="center">
              <Column sm={12} md={10} textAlign="center">
                <Heading>Learn more about your Dawson candidates</Heading>
                <p>
                  <a target="_blank" href="https://www.liberal.org.au/member/george-christensen">
                ...
                <p>
                  <a
                    target="_blank"
                    href="https://www.alp.org.au/our-people/our-people/belinda-hassan/"
                  >
                    Belinda Hassan – ALP
                  </a>
                </p>
                <p>
                  <a target="_blank" href="http://www.dlpqld.org.au/">
                    Ann-Maree Ware – Labour DLP
                  </a>
                </p>
                <p>
                  <a target="_blank" href="https://www.conservativenationalparty.org/dawson">
                    Michael Wayne Turner - Fraser Anning’s Conservative National Party
                  </a>
                </p>
                <p>
                  <a target="_blank" href="https://www.onenation.org.au/our-team/debra-lawson/">
                    Debra Lawson – One Nation
                  </a>
                </p>
                <p>
                  <a target="_blank" href="https://www.kap.org.au/dawson/">
                    Bredan Bunyan – Katter’s Australian Party
                  </a>
                </p>
                <p>
                  <a target="_blank" href="https://greens.org.au/qld/person/imogen-lindenberg">
                ...
                <p>
                  <a
                    target="_blank"
                    href="https://www.unitedaustraliaparty.org.au/candidates/colin-thompson/"
                  >
                    Colin Richard Thompson – United Australia Party
                  </a>
                </p>
              </Column>
            </Row>
